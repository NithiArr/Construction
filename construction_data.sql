...
SELECT pg_catalog.setval('public.expense_expense_id_seq1', 27, true);
...
SELECT pg_catalog.setval('public.expense_item_expense_item_id_seq1', 29, true);
...
SELECT pg_catalog.setval('public.master_category_category_id_seq1', 11, true);
...
SELECT pg_catalog.setval('public.project_project_id_seq1', 5, true);
...
SELECT pg_catalog.setval('public.sub_category_subcategory_id_seq1', 63, true);
...
SELECT pg_catalog.setval('public.vendor_vendor_id_seq1', 8, true);
